    ...
    <div class="app-wrap">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-nav" style="margin-top:1rem">
                <ul class="sidebar-nav" style="margin-top:1rem">
                    <ul class="sidebar-nav" style="margin-top:1rem">
                        <li><a href="<?= base_url('/employee') ?>"><i class="bi bi-grid-1x2"></i> Tableau de bord</a>
                        </li>
                        <li><a href="<?= base_url('/employee/create') ?>"><i class="bi bi-plus-circle"></i> Nouvelle
                                demande</a></li>
                        <li><a href="<?= base_url('/employee/demandes') ?>"><i class="bi bi-calendar3"></i> Mes
                                demandes</a></li>
                        <li><a href="<?= base_url('/employee/profil') ?>"><i class="bi bi-person"></i> Mon profil</a>
                        </li>
                    </ul>
                </ul>
            </ul>
            <div class="sidebar-user">
                <div class="s-user-row">
                    ...
                    <div>
                        ...
                        <div class="user-role">Employé · <?= esc(session()->get('user')['role'] ?? 'Général') ?></div>
                    </div>
                </div>
            </div>
        </aside>
