    ...
    <div class="app-wrap">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-nav">
                <li><a href="#page-dashboard-employe" class="active"><i class="bi bi-grid-1x2"></i> Tableau de bord</a>
                </li>
            ...
            <div class="sidebar-user">
                <div class="s-user-row">
                    ...
                    <a href="#page-login" style="margin-left:auto;color:rgba(255,255,255,.25);font-size:1.1rem"
            ...
            <div class="content">
                ...
                <div class="data-card">
                    <div class="data-card-head">
                        ...
                        <a href="#page-mes-conges" style="font-size:.8rem;color:var(--forest);text-decoration:none">Voir
                            tout →</a>
                    </div>
                    <table class="tbl">
                        <thead>
